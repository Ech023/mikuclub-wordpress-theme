                                ...
                                <div class="col-auto ">
                                    ...
                                    if (get_current_user_id() === $author->id || current_user_is_admin()) {
                                        ...
                                        <div class="post-edit-link my-1 my-md-0">
                                            <a class="text-info" href="<?php echo get_edit_post_link($post_id); ?>"
                                            target="_blank">[编辑投稿]</a>
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class=" col-12 col-lg-4">
                            <div class="post-author-data rounded p-3">
                                ...
                                if (get_current_user_id() > 0 && get_current_user_id() != $author->id) {
                                    ?>
                                    <div class="my-2 user-functions">
                                        <button class="btn btn-sm <?php echo $is_user_followed ? "btn-secondary unfollow" : "btn-miku follow"; ?> me-2 user-followed"
                                                data-user-id="<?php echo $author->id ?>">
                                        <span class="text follow"
                                            style="display : <?php echo $is_user_followed ? 'none' : 'inline'; ?>">
                                        ...
                                        <div class="create-private-message-modal d-inline-block">
